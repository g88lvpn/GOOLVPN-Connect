...
object SettingsKey {
    ...
    const val GOOLVPN_UPDATE_CHANNEL_INITIALIZED = "goolvpn_update_channel_initialized"
    const val GOOLVPN_UPDATE_PRELOAD_INITIALIZED = "goolvpn_update_preload_initialized"
    ...
    const val GOOLVPN_THEME_MODE = "goolvpn_theme_mode"
    ...
    const val UPDATE_READY_NOTIFIED_VERSION = "update_ready_notified_version"
}
